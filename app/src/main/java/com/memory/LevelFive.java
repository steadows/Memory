...
public class LevelFive extends Fragment {
    ...
    private final int[] cardDeck = {R.id.card5_1, R.id.card5_2, R.id.card5_3, R.id.card5_4,
            R.id.card5_5, R.id.card5_6, R.id.card5_7, R.id.card5_8, R.id.card5_9, R.id.card5_10,
            R.id.card5_11, R.id.card5_12, R.id.card5_13, R.id.card5_14, R.id.card5_15,
            R.id.card5_16, R.id.card5_17, R.id.card5_18, R.id.card5_19, R.id.card5_20,
            R.id.card5_21, R.id.card5_22, R.id.card5_23, R.id.card5_24};
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.level_five, container, false);
    }
    ...
    public void onViewCreated(@NonNull View view, Bundle savedInstanceState) {
        ...
        // Assign to variables
        timerText = view.findViewById(R.id.timer_text5);
        matches = view.findViewById(R.id.score_number_text5);
        PulseCountDown pulseCountDown = view.findViewById(R.id.pulseCountDown5);
        ...
        if (Boolean.FALSE.equals(SubMenu.traditionalMode)) {
            new CountDownTimer(5000, 1000) {
                ...
                public void onTick(long millisUntilFinished) {
                    timerText.setText(R.string.level4);
                }
    ...
    public void timeUp() {
        ...
        ImageView backButton = requireActivity().findViewById(R.id.timeUpButtonSubMenu5);
        TextView backText = requireActivity().findViewById(R.id.timeUpButtonSubMenuText5);
        ImageView retryButton = requireActivity().findViewById(R.id.timeUpButtonRetry5);
        TextView retryText = requireActivity().findViewById(R.id.timeUpButtonRetryText5);
        TextView timeUpText = requireActivity().findViewById(R.id.timeUpText5);
        ...
        retryButton.setOnClickListener(view1 -> {
            ...
            navController.navigate(R.id.levelFive);
        });
