...
public class LevelEight extends Fragment {
    ...
    private final int[] images = { R.drawable.louie, R.drawable.michigan_flag, R.drawable.lions,
            ...
            R.drawable.outlinemi, R.drawable.wayne, R.drawable.cherry_farm};

    private final int[] cardDeck = { R.id.card8_1, R.id.card8_2, R.id.card8_3, R.id.card8_4,
            R.id.card8_5, R.id.card8_6, R.id.card8_7, R.id.card8_8, R.id.card8_9, R.id.card8_10,
            R.id.card8_11, R.id.card8_12, R.id.card8_13, R.id.card8_14, R.id.card8_15,
            R.id.card8_16, R.id.card8_17, R.id.card8_18, R.id.card8_19, R.id.card8_20,
            R.id.card8_21, R.id.card8_22, R.id.card8_23, R.id.card8_24};
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.level_eight, container, false);
    }
    ...
    public void onViewCreated(@NonNull View view, Bundle savedInstanceState) {
        ...
        // Assign to variables
        timerText = view.findViewById(R.id.timer_text8);
        matches = view.findViewById(R.id.score_number_text8);
        PulseCountDown pulseCountDown = view.findViewById(R.id.pulseCountDown8);
        ...
        if(Boolean.FALSE.equals(SubMenu.traditionalMode)) {
            new CountDownTimer(5000, 1000) {
                @Override
                public void onTick(long millisUntilFinished) { timerText.setText(R.string.level7); }
    ...
    public void timerDown(){
        ...
        CountDownTimer timerCount = new CountDownTimer(180000, 1) {
    ...
    public void timeUp(){
        ...
        ImageView backButton = requireActivity().findViewById(R.id.timeUpButtonSubMenu8);
        TextView backText = requireActivity().findViewById(R.id.timeUpButtonSubMenuText8);
        ImageView retryButton = requireActivity().findViewById(R.id.timeUpButtonRetry8);
        TextView retryText = requireActivity().findViewById(R.id.timeUpButtonRetryText8);
        TextView timeUpText = requireActivity().findViewById(R.id.timeUpText8);
        ...
        retryButton.setOnClickListener(view1 -> {
            ...
            navController.navigate(R.id.levelEight);
        });
        ...
        new CountDownTimer(3000, 1000) {
            ...
            public void onTick(long millisUntilFinished) {/* Nothing to do during countdown */ }
            @Override
            public void onFinish() { new CountDownTimer(1000000, 10000) {
                @Override
