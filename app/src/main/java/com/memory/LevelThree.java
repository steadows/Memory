...
public class LevelThree extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, Bundle savedInstanceState) {
        ...
        if(Boolean.FALSE.equals(SubMenu.traditionalMode)) {
            new CountDownTimer(5000, 1000) {
                @Override
                public void onTick(long millisUntilFinished) { timerText.setText(R.string.level3); }
    ...
    public void timerDown(){
        ...
        CountDownTimer timerCount = new CountDownTimer(60000, 1) {
    ...
    public void timeUp(){
        ...
        ImageView backButton = requireActivity().findViewById(R.id.timeUpButtonSubMenu3);
        TextView backText = requireActivity().findViewById(R.id.timeUpButtonSubMenuText3);
        ImageView retryButton = requireActivity().findViewById(R.id.timeUpButtonRetry3);
        TextView retryText = requireActivity().findViewById(R.id.timeUpButtonRetryText3);
        TextView timeUpText = requireActivity().findViewById(R.id.timeUpText3);
        ...
        retryButton.setOnClickListener(view1 -> {
            ...
            navController.navigate(R.id.levelThree);
        });
