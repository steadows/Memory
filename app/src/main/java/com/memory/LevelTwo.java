...
public class LevelTwo extends Fragment {
    ...
    private final int[] cardDeck = { R.id.card2_1, R.id.card2_2, R.id.card2_3, R.id.card2_4,
            R.id.card2_5, R.id.card2_6, R.id.card2_7, R.id.card2_8, R.id.card2_9, R.id.card2_11,
            R.id.card2_10, R.id.card2_12};
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.level_two, container, false);
    }
    ...
    public void onViewCreated(@NonNull View view, Bundle savedInstanceState) {
        ...
        PulseCountDown pulseCountDown = view.findViewById(R.id.pulseCountDown2);
        ...
        if(Boolean.FALSE.equals(SubMenu.traditionalMode)) {
            new CountDownTimer(5000, 1000) {
                @Override
                public void onTick(long millisUntilFinished) { timerText.setText(R.string.level2); }
    ...
    public void timerDown(){
        ...
        CountDownTimer timerCount = new CountDownTimer(45000, 1) {
    ...
    public void timeUp(){
        ...
        ImageView backButton = requireActivity().findViewById(R.id.timeUpButtonSubMenu2);
        TextView backText = requireActivity().findViewById(R.id.timeUpButtonSubMenuText2);
        ImageView retryButton = requireActivity().findViewById(R.id.timeUpButtonRetry2);
        TextView retryText = requireActivity().findViewById(R.id.timeUpButtonRetryText2);
        TextView timeUpText = requireActivity().findViewById(R.id.timeUpText2);
        ...
        retryButton.setOnClickListener(view1 -> {
            ...
            navController.navigate(R.id.LevelTwo);
        });
